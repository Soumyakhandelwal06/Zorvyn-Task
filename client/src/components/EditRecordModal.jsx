...
const EditRecordModal = ({ record, onClose, onRecordUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`/api/records/${record.id}`, parsedData, {
      ...
      if (error instanceof z.ZodError) {
        ...
        console.error(error);
        toast.error('Failed to update record. Ensure you have ADMIN permissions.');
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div style={{
      ...
      >
        <h2 style={{ marginBottom: '1.5rem' }}>Edit Entry</h2>
